...
These settings are exported from my PHP Storm setup, but can be customized in VS Code.

First, add the PHP extension from DevSense.

Next, create or open the `.editorconfig` file in the root of the project, and add the following settings.

Source/instructions for customizing:
https://docs.devsense.com/vscode/formatting/customize-formatting/

To add WordPress support:
https://blog.devsense.com/2023/wordpress-intellisense-linting-vscode

```editorconfig


[{*.ctp,*.hphp,*.inc,*.module,*.php,*.php4,*.php5,*.phtml,barebones-plugin}]
...
ij_php_space_before_catch_parentheses = false
