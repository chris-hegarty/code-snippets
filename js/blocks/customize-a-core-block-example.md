...
This example show how to add a toggle switch to the Columns block to reverse directions.

(Example from Nick Diego: https://github.com/ndiego/enable-column-direction/blob/main/src/index.js)
